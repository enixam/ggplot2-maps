...
`scale_x_continuous()` and `scale_y_continuous()` gains an `n.breaks` argument guiding the number of automatic generated breaks, this is equavalent to supply `breaks` with a function.  
